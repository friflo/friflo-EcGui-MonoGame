...
internal static class TypeDrawers
{
    ...
    /// </summary>
    internal static void Register(ImGuiRenderer renderer)
    {
        ...
        EcGui.Setup.RegisterTypeDrawer<Sprite>    (new SpriteDrawer(renderer));
        
        // --- Microsoft.Xna.Framework types
        EcGui.Setup.RegisterTypeDrawer<Microsoft.Xna.Framework.Point>   (new PointDrawer());
        EcGui.Setup.RegisterTypeDrawer<Microsoft.Xna.Framework.Vector2> (new Vector2Drawer());
        EcGui.Setup.RegisterTypeDrawer<Microsoft.Xna.Framework.Vector3> (new Vector3Drawer());
        EcGui.Setup.RegisterTypeDrawer<Microsoft.Xna.Framework.Vector4> (new Vector4Drawer());
    }
}
